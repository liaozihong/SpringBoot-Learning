...
public class GitCaptcha extends Captcha {
    public GitCaptcha() {
    }

    public GitCaptcha(int width, int height) {
        this.width = width;
        this.height = height;
    }

    public GitCaptcha(int width, int height, int len) {
        this(width, height);
        this.len = len;
    }

    public GitCaptcha(int width, int height, int len, Font font) {
